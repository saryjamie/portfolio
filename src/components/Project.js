          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {projectData &&
              projectData.map((project) => (
                <article>
                  <span className="block h-160 relative rounded reounded-lg shadow-xl bg-blue-200 p-5 border hover:bg-blue-300">
                    ...
                    <div className="text-gray-500 text-xs space-x-4 pr-8">
                      ...
                      <span>
                        ...
                        <a
                          ...
                          rel="noopener noreferrer"
                          target="_blank"
                          className="text-blue-700 font-bold text-xl hover:text-red-600 justify-center text-decoration-none"
                        >
                          LIVE{" "}
                        </a>
                        <a
                          ...
                          rel="noopener noreferrer"
                          target="_blank"
                          className="m-10 text-blue-700 font-bold text-xl hover:text-red-600 justify-center text-decoration-none"
                        >
                          GitHub{" "}
                        </a>
                      </span>
